        ...
        <div className="flex flex-col lg:flex-row justify-between gap-10 mt-6">
          ...
          <div className="w-full lg:w-1/2">
            ...
            >
              <input
                ...
                } bg-white rounded px-4 py-3 outline-none focus:border-primary`}
              />
              {errors.name && (
              ...
              <textarea
                ...
                } bg-white rounded px-4 py-3 outline-none focus:border-primary resize-none`}
              />
              {errors.message && (
          ...
          <div className="w-full lg:w-1/2">
            <div className="mt-10 lg:mt-0">
              ...
              <a
                href="tel:+2348144020781"
                className="text-primary underline block mb-1 hover:text-primary-dark transition"
              >
                +2348144020781
              </a>
              <a
                href="mailto:kaytorah55@gmail.com"
                className="text-primary underline block hover:text-primary-dark transition"
              >
